...
//  Element     Display Name    Graphic     Points      Alt Points  Order      Alt Order
    ...
    NINE    (   "Nine",         "9",        9,          9,          9,          9 ),
    /** Ten */
    SKIP     (   "Skip",          "Sk",       10,         10,         10,         10 ),
    /** Jack */
    REVERSE    (   "Reverse",         "Re",        11,         11,         11,         11 ),
    /** Queen */
    DRAW2   (   "Draw 2",        "D2",        12,         12,         12,         12 ),
    
    DRAW4   (   "Draw 4",         "D4",        11,         11,         11,         11 ),
    /** Queen */
    MULTICOLOR   (   "MultiColor",        "MC",        12,         12,         12,         12 ),;
    ;
// @formatter:on
